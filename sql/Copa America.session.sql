...
CREATE TABLE IF NOT EXISTS Detalles_Grupos(
...
CREATE TABLE IF NOT EXISTS detalles_sedes (
...
CREATE TABLE IF NOT EXISTS tipo_personas_tecnicas(
  id_tipoPersona int(11) NOT NULL AUTO_INCREMENT,
  tx_persona VARCHAR(80),
  PRIMARY KEY (id_tipoPersona)
) ENGINE = InnoDB;
CREATE TABLE IF NOT EXISTS personas_tecnicas(
  id_persona int(11) NOT NULL AUTO_INCREMENT,
  id_tipoPersona int(11),
  id_pais int(11),
  tx_persona VARCHAR(100),
  PRIMARY KEY (id_persona),
  FOREIGN KEY(id_tipoPersona) REFERENCES tipo_personas_tecnicas(id_tipoPersona) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY(id_pais) REFERENCES paises(id_pais) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB;
CREATE TABLE IF NOT EXISTS Equipo(
  ...
  FOREIGN KEY(id_copa) REFERENCES copa(id_copa) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY(id_pais) REFERENCES paises(id_pais) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY(id_persona) REFERENCES personas_tecnicas(id_persona) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS Partidos(
  ...
  FOREIGN KEY(id_copa) REFERENCES copa(id_copa) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY(id_tipoPartidos) REFERENCES tipo_partido(id_tipoPartidos) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  FOREIGN KEY(id_persona) REFERENCES personas_tecnicas(id_persona) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY(id_persona_var) REFERENCES personas_tecnicas(id_persona) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB;
